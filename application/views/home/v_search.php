...
<div style="margin-top: 175px; height: 800px; padding: 10px;">
    ...
    <form style="margin: auto; width: 600px; padding: 10px;" action="<?php echo base_url(); ?>home/cari" method="POST">
        <input class="form-control mr-sm-2" type="text" placeholder="Scan Barcode atau Cari Alamat disini ..." aria-label="Search" name="inputsearch" required autofocus>
